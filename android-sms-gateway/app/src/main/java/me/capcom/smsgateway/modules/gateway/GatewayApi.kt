...
class GatewayApi(
    ...
    suspend fun postInboxMessage(token: String, request: InboxMessageRequest) {
    ...
    data class InboxMessageRequest(
        ...
        val receivedAt: Date,
        val textMessage: InboxTextMessage?,
        val dataMessage: InboxDataMessage?,
    )

    data class InboxTextMessage(
        val text: String,
    )

    data class InboxDataMessage(
        val data: String,
    )
